 ...
 */
// 1
var shopItemsArray: [String] = ["Gold", "Gemstones", "Iron"]
var shopItemsDictionary: [String: Int] = ["Gold": 10, "Gemstones": 5, "Iron": 12]
// 2
shopItemsArray.contains("Platinum")
// 3
shopItemsArray.insert("Platinum", at: 2)
// 4
var selectedItem = shopItemsArray[0]
// 5
var selectedItemPrice = shopItemsDictionary[selectedItem]
// 6
var fullArmorSet: Set<String> = ["Nobel", "Warrior", "Elite"]
var currentArmorSet: Set<String> = ["Warrior", "Elite"]
// 7
fullArmorSet.subtracting(currentArmorSet)
// 8
var armorPieceTuple = (name: "Hawk", cost: 12, canEquip: true)
